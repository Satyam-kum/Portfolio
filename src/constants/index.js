...
export const EDUCATION = [
  {
    ...
    description:
      "Currently a second-year student with a CGPA of 7.2. Possesses skills in Data Structures and Algorithms (DSA) and full stack development. Completed various projects and internships in web development.",
  },
  {
    year: "-----",
